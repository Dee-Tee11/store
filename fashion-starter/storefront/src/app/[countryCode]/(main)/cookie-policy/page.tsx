...
export default function CookiePolicyPage() {
  return (
    <Layout className="pt-30 pb-20 md:pt-47 md:pb-32">
      ...
      >
        <p>
          This Cookie Policy explains how South Store uses cookies and similar
        ...
        <p>
          ...
          Cookie Policy or how we handle your personal information, send us a
